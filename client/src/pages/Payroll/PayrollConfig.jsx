      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-3">
          ...
          <div className="space-y-1">
            <button className="w-full px-3 py-2 text-sm rounded bg-blue-50 text-blue-700 border border-blue-200 text-left">Payroll Config</button>
            ...
            <button className="w-full px-3 py-2 text-sm rounded bg-white border text-left">Post Payroll</button>
            <button className="w-full px-3 py-2 text-sm rounded bg-white border text-left">Dashboard</button>
          </div>
        </div>
